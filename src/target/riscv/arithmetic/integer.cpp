...
VILL::vpu_return_t VARITH_INT::vnsrl_wv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
	...
	// Destination and source (vs2) can overlap if the overlap is in the lowest-numbered part of the source register group, 
	// e.g., when LMUL=1, vnsrl.wi v0, v0, 3 is legal, but a destination of v1 is not.
	if (src_vec_reg_lhs != dst_vec_reg &&
			vd.check_mem_overlap(vs2) != 0) {
...
VILL::vpu_return_t VARITH_INT::vnsrl_wi(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnsrl_wx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnsra_wv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
	...
	// Overlap rules for narrowing instructions: 
	// Destination and source (vs2) can overlap if the overlap is in the lowest-numbered part of the source register group, 
	// e.g., when LMUL=1, vnsra.wi v0, v0, 3 is legal, but a destination of v1 is not.
	if (src_vec_reg_lhs != dst_vec_reg &&
			vd.check_mem_overlap(vs2) != 0) {
		return(VILL::VPU_RETURN::NARROWING_OVERLAP_VD_VS2_ILL);
	}
...
VILL::vpu_return_t VARITH_INT::vnsra_wi(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnsra_wx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::msgtu_vi(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::msgt_vi(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vdiv_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vrem_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vrem_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vremu_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vremu_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmax_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmaxu_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmaxu_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmin_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmin_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vminu_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vminu_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmadc_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmadc_vi(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmadc_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vsbc_vvm(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vsbc_vxm(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmsbc_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmsbc_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmacc_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmacc_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnmsac_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnmsac_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmadd_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vmadd_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnmsub_vv(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
...
VILL::vpu_return_t VARITH_INT::vnmsub_vx(
	uint8_t* vec_reg_mem,
	uint64_t emul_num,
	uint64_t emul_denom,
	uint16_t sew_bytes,
